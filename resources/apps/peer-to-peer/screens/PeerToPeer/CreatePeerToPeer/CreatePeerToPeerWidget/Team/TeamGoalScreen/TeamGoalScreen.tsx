...
import styles from './TeamGoalScreen.styles.scss'
...
const TeamGoalScreen: FC<Props> = ({ index }) => {
  ...
  const percentage = useMemo(() => getPercentage(team.goalAmount), [team.goalAmount])
  ...
  return (
    <>
      <WidgetHeader indexToNavigate={SCREENS.NAME} onCloseHref={org_website}>
        <a href={org_website} aria-label='go to home page'>
          <img src={logo_url} className='object-cover w-6 h-6' alt='' />
        </a>
      </WidgetHeader>
