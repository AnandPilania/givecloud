        ...
        this.vm = new Vue({
            ...
            mounted: function() {
                ...
                if (this.payment_method.subscriptions.length > 0) {
                    ...
                    this.account.subscriptions.forEach(function(subscription) {
                        if (_.includes(['active', 'suspended'], subscription.status)) {
                            self.subscription_ids.push(subscription.id);
                        }
                    });
                }
            ...
            methods: {
                ...
                money: function(value, currency) {
                    return theme.money(value, currency ? currency.code : undefined);
                },
            ...
            filters: {
                date: function (dateString) {
                    ...
                    return new Intl
                        .DateTimeFormat(Givecloud.config.locale.iso, { dateStyle: "long" })
