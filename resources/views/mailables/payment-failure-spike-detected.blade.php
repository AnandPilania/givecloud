...
<body style="word-spacing:normal;background-color:#F4F4F4;">
  <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> The have been {{ $failedCount }} payment failures over the last {{ $evaluationWindow }} minutes. </div>
                            ...
                            <tbody>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Inter, Arial;font-size:14px;line-height:1.4;table-layout:auto;width:100%;border:none;">
                                    <tr>
                                      <td style="vertical-align:middle" width="95">
                                        <img src="https://cdn.givecloud.co/static/notifications/fa-dark-exclamation-circle.png" alt style="width:70px;height:auto">
                                      </td>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:16px;font-weight:300;line-height:1.4;text-align:left;color:#474747;">
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:16px;font-weight:300;line-height:1.4;text-align:left;color:#000000;">
                              ...
                              <tr>
                                <td align="left" vertical-align="middle" style="font-size:0px;padding:20px;word-break:break-word;">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align="center" bgcolor="#fc58af" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#fc58af;" valign="middle">
                                          <a href="{{ url('jpanel/reports/payments?fp=failed') }}" style="display:inline-block;background:#fc58af;color:white;font-family:Inter, Arial;font-size:16px;font-weight:500;line-height:1.4;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:30px;" target="_blank"> Review Contributions </a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:13px;font-weight:300;line-height:1.4;text-align:left;color:#989898;">
                                    ...
                                    <a href="https://help.givecloud.com/en/articles/3508435-carding-bots-preventing-fraud"> https://help.givecloud.com/en/articles/3508435-carding-bots-preventing-fraud </a>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
