...
<body style="word-spacing:normal;background-color:#F4F4F4;">
  <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> Linked accounts confirmation </div>
                            ...
                            <tbody>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:18px;font-weight:300;line-height:1.4;text-align:left;color:#474747;">Follow the link below to sign-in into your account through {{ ucfirst($provider) }}.</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:16px;line-height:1.4;text-align:left;color:#474747;">This link will be valid for <strong>{{ $ttl }} minutes</strong>.</div>
                                </td>
                              </tr>
                              <tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align="center" bgcolor="#fc58af" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#fc58af;" valign="middle">
                                          <a href="{{ $url }}" style="display:inline-block;background:#fc58af;color:white;font-family:Inter, Arial;font-size:16px;font-weight:500;line-height:1.4;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:30px;" target="_blank"> Confirm </a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
