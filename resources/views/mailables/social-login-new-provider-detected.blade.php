                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-bottom:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:14px;line-height:1.4;text-align:left;color:#000000;">
                                    <h1>Hey {{ $member->first_name }},</h1>
                                  </div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:18px;font-weight:300;line-height:1.4;text-align:left;color:#474747;">We have detected a new login to your account using {{ ucfirst($provider) }}.</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:16px;line-height:1.4;text-align:left;color:#474747;">If this was not you, please contact us.</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
