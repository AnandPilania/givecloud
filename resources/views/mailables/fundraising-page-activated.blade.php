...
<body style="word-spacing:normal;background-color:#F4F4F4;">
  <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> "{{ $page_name }}" was created by {{ $page_author }}. </div>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#000000;font-family:Inter, Arial;font-size:14px;line-height:1.4;table-layout:auto;width:100%;border:none;">
                                    <tr>
                                      <td style="vertical-align:middle" width="95">
                                        <img src="https://cdn.givecloud.co/static/notifications/fa-dark-check.png" alt style="width:70px;height:auto">
                                      </td>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:18px;font-weight:300;line-height:1.4;text-align:left;color:#474747;">
                                    <p><a href="{{ $page_author_url }}">{{ $page_author }}</a> created a new fundraising page:</p>
                                  </div>
                                </td>
                              </tr> @if($page_author_verified_status === 'Verified') <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:20px;font-weight:700;line-height:1.4;text-align:left;color:#474747;">
                                    <p>
                                      {{ $page_author }} has already been approved to create fundraisers and so this page is live to the public. If you feel that this is an error, please visit the <a href="{{ $page_admin_url }}" target="_blank">{{ $page_name }}</a> page to verify {{ $page_author }}.
                                    </p>
                                  </div>
                                </td>
                              </tr> @endif @if($page_author_verified_status_is_pending) <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:20px;font-weight:700;line-height:1.4;text-align:left;color:#474747;">
                                    <p> This fundraising page is not public as {{ $page_author }} has not been verified. Please visit the page <a href="{{ $page_admin_url }}" target="_blank">{{ $page_name }}</a> page to verify {{ $page_author }}. </p>
                                  </div>
                                </td>
                              </tr> @endif <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                  ...
                  <tbody>
                    <tr>
                      <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                            ...
                            <tbody>
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:18px;font-weight:300;line-height:1.4;text-align:left;color:#989898;">
                                    <p>
                                      {{ $page_goal }}<br>
                        ...
                        <!--[if mso | IE]></td><![endif]--> @if ($page_deadline)
                        <!--[if mso | IE]><td class="" style="vertical-align:top;width:290px;" ><![endif]-->
                        <div class="mj-column-per-50 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            <tbody>
                              <tr>
                              ...
                              <tr>
                                <td align="center" vertical-align="middle" style="font-size:0px;padding:20px;word-break:break-word;">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                    <tbody>
                                      <tr>
                                        <td align="center" bgcolor="#82c069" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#82c069;" valign="middle">
                                          <a href="{{ $page_url }}" style="display:inline-block;background:#82c069;color:white;font-family:Inter, Arial;font-size:16px;font-weight:500;line-height:1.4;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:30px;" target="_blank"> View Page </a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                              ...
                              <tr>
                                <td align="center" vertical-align="middle" style="font-size:0px;padding:20px;word-break:break-word;">
                                  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                    <tbody>
                                      <tr>
                                        <td align="center" bgcolor="#d95263" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#d95263;" valign="middle">
                                          <a href="{{ $page_suspend_url }}" style="display:inline-block;background:#d95263;color:white;font-family:Inter, Arial;font-size:16px;font-weight:500;line-height:1.4;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:30px;" target="_blank"> Suspend Page </a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
