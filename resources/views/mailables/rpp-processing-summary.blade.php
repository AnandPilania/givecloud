...
<body style="word-spacing:normal;background-color:#F4F4F4;">
  <div style="display:none;font-size:1px;color:#ffffff;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;"> Givecloud successfully processed {{ $transactions_processed }} recurring payments. </div>
        ...
        <tbody>
          <tr>
            <td style="direction:ltr;font-size:0px;padding:40px 10px;text-align:center;">
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            <tbody>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:18px;font-weight:700;line-height:1.4;text-align:left;color:#474747;">
                                    <p> ({{ $transactions_approved }}) Payments Approved<br> ({{ $transactions_declined }}) Payments Declined </p>
                                  </div>
                                </td>
                              </tr>
                              <tr>
                                    ...
                                    <tbody>
                                      <tr>
                                        <td align="center" bgcolor="#fc58af" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#fc58af;" valign="middle">
                                          <a href="{{ $transactions_url }}" style="display:inline-block;background:#fc58af;color:white;font-family:Inter, Arial;font-size:16px;font-weight:500;line-height:1.4;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:30px;" target="_blank"> Review Transactions </a>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                </td>
                              </tr> @if ($is_auto_follow_up) <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:13px;font-weight:300;line-height:1.4;text-align:left;color:#989898;">
              ...
              <!--[if mso | IE]></td></tr></table></td></tr><![endif]--> @unless ($is_auto_follow_up)
              <!--[if mso | IE]><tr><td class="spacer-outlook" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="spacer-outlook" role="presentation" style="width:580px;" width="580" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
              <div class="spacer" style="padding: 0px; height: 20px; margin: 0px auto; max-width: 580px;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                  <tbody>
                        ...
                        <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                          <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                            <tbody>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:16px;font-weight:300;line-height:1.4;text-align:left;color:#989898;">
                                    <p> Givecloud can automatically notify those whose payments failed. You can set this up under <a href="{{ secure_site_url('/jpanel/settings/email') }}">Settings &amp; Admin &gt; Emails</a>. </p>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
              ...
              <!--[if mso | IE]></td></tr></table></td></tr><![endif]--> @endunless
              <!--[if mso | IE]><tr><td class="spacer-outlook" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="spacer-outlook" role="presentation" style="width:580px;" width="580" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
              <div class="spacer" style="padding: 0px; height: 20px; margin: 0px auto; max-width: 580px;">
                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
                  <tbody>
