                            ...
                            <tbody>
                              ...
                              <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;word-break:break-word;">
                                  <div style="font-family:Inter, Arial;font-size:20px;font-weight:700;line-height:1.2;text-align:left;color:#474747;">
                                    <p>{{ $subject }}</p>
                                  </div>
                                </td>
                              </tr> @if (count($fields)) <tr>
                                <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="color:#474747;font-family:Inter, Arial;font-size:16px;line-height:1.4;table-layout:auto;width:100%;border:none;"> @foreach ($fields as $field => $value) <tr>
