    ...
    <div class="col-lg-12">
        <h1 class="page-header clearfix">
            ...
            <div class="pull-right">
                <a href="/jpanel/import/history" class="btn btn-default"><i class="fa fa-search fa-fw"></i> Import History</a>
                <button type="submit" class="btn btn-success">Start Analysis <i class="fa fa-arrow-right"></i></button>
    ...
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="panel-sub-title">Step 1: Import Type</div>
...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="panel-sub-title">Step 2: Upload File</div>
                <div class="panel-sub-desc">
                    Choose the type of import you'd like to perform.

                    <br><br>
                    <p class="text-info">
                        <strong><i class="fa fa-info-circle"></i> Note</strong><br>The sequence of your file's columns must match the columns in the template provided above.
                    </p>
                </div>
            </div>
