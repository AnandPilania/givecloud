<script>
    exportRecords = function () {
        ...
        window.location = '/jpanel/sponsors.csv?' + $.param(d);
    }
</script>
    ...
    <div class="col-lg-12">
        <h1 class="page-header">
            ...
            <div class="pull-right">
                ...
                <?= dangerouslyUseHTML(($sponsorship) ? "&nbsp;<small>".e($sponsorship->first_name)." ".e($sponsorship->last_name)."</small>" : '') ?>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="row">
                            ...
                            <div class="col-xs-12 stat">
                                <div class="stat-value-bold text-success">
                                    <?= e(money($recurring_payments_stats->total)->format('$0,0')) ?>
                                </div>
    ...
    <form class="datatable-filters">
        ...
        <div class="datatable-filters-fields">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-5 col-md-5 col-sm-6 col-xs-6 hide more-field">
                    <div class="input-group input-daterange">
                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                ...
                <div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-6 hide more-field">
                ...
                <div class="form-group col-lg-5 col-md-4 col-sm-6 col-xs-6 hide more-field">
                    <div class="input-group">
                ...
                <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-6 hide more-field">
                ...
                <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                    <button type="button" class="btn btn-default toggle-more-fields">More Filters</button>
                </div>
