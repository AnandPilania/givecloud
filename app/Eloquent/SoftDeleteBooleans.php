...
trait SoftDeleteBooleans
{
     ...
     * @return void
     */
    public static function bootSoftDeleteBooleans()
    {
    ...
    {
        return (new static)->newQueryWithoutScope(new SoftDeletingBooleanScope);
    }
    ...
    public static function onlyTrashed()
    {
        ...
        return $instance->newQueryWithoutScope(new SoftDeletingBooleanScope)->where($column, 1);
    }
