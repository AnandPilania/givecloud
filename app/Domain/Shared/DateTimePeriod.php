 ...
 * Class DatePeriod
 *
 * @see https://github.com/pwm/datetime-period
...
class DateTimePeriod
{
    ...
    public function merge(DateTimePeriod $period): DateTimePeriod
    {
        return new self(
            min($this->getStart(), $period->getStart()),
            max($this->getEnd(), $period->getEnd())
        );
    }

    public function mergeInto(DateTimePeriod $period): self
    {
        $this->start = min($this->getStart(), $period->getStart());
        $this->end = max($this->getEnd(), $period->getEnd());
